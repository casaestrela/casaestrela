...
class ProductTemplate(models.Model):
    ...
    default_code = fields.Char('Internal Reference', index=True,store=True,readonly='1')#compute='compute_internal_reference',
    ...
    def create(self, vals_list):
        ...
        for vals in vals_list:
            ...
            if vals.get("categ_id", False):
                ...
                code = '%s - %s' %(category_id.category_prefix,number)
...
class ProductProduct(models.Model):
    ...
    default_code = fields.Char('Internal Reference', index=True)#,store=True,compute='compute_internal_reference'
