# -*- coding: utf-8 -*-
{
    ...
    'author':'Evozard',
    'category': 'Purchase',
    'summary': """Enable auto purchase workflow with purchase order confirmation. Include operations like Auto Create Invoice, Auto Validate Invoice and Auto Transfer Delivery Order.""",
    'description': """
