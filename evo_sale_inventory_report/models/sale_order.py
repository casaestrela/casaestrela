...
class SaleOrderLine(models.Model):
    ...
    pending_delivery_qty = fields.Float(compute='_get_to_delivery_qty', string='Pending Delivery Quantity', readonly=True, digits='Product Unit of Measure')
    invoice_names = fields.Char(compute='_get_invoice_name', string="Invoices")
    delivery_order_names = fields.Char(compute='_get_delivery_order_name', string="Delivery Order")
