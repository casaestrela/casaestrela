        ...
        if result:
            ...
            for row in result:
                ...
                try:
                    ...
                    product_tmpl_id = self.env['product.template'].search([('default_code','=',default_code)],limit=1)
                    ...
                    pricelist_item_id = pricelist_item.search([('pricelist_id','=',pricelist_id.id),('product_tmpl_id','=',product_tmpl_id.id)],limit=1)
