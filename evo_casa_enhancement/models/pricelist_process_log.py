...
class ProcessLog(models.Model):
    ...
    process_date = fields.Date('Date',default=lambda self: self._context.get('date', fields.Date.context_today(self)))
    ...
    processed_log_details_ids = fields.One2many('pricelist.process.detail.log','process_log_id',string='Error Details')
