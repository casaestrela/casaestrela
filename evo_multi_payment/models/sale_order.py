...
class SaleOrder(models.Model):
        ...
        for rec in self:
            if rec.invoice_ids:
                ...
                for inv in rec.invoice_ids:
                    inv_payment = self.env['advance.payment.line'].search([('invoice_id', '=', inv.id),('invoice_id', '!=', False)])
    ...
    total_sale_payment = fields.Monetary(string="Total Invoiced", compute='payment_total')
